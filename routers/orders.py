...
async def create_order(order_data: OrderCreate, db: Session = Depends(get_db)):
    ...
    try:
        ...
        <body>
          <div class="container">
            <div class="header">
              <img src= "https://hebbkx1anhila5yf.public.blob.vercel-storage.com/rosalie-logo-d4qGzqKkC3XHbflwcxgmFjRlZUV9dp.jpg" alt="SHOP_BY_ZALIE Logo" class="logo">
              <h1 style="margin: 0; font-size: 28px;">SHOP_BY_ZALIE</h1>
            ...
            <div class="footer">
              <p style="margin: 0 0 10px 0; font-size: 16px; font-weight: bold;">SHOP_BY_ZALIE</p>
        ...
        async with httpx.AsyncClient() as client:
            response = await client.post(
                ...
                json={
                    "sender": {"email": "diallo30amadoukorka@gmail.com", "name": "SHOP_BY_ZALIE"},
                    "to": [{"email": OWNER_EMAIL, "name": "Propriétaire SHOP_BY_ZALIE"}],
                    "subject": f"🛍️ Nouvelle commande #{db_order.id} - SHOP_BY_ZALIE",
